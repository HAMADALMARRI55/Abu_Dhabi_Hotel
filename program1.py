...
class Customer:
    ...
    def enter_personal_details(self):
        ...
        self.set_email("hamadalmarri@gmail.com")
        self.set_phone("056-2266373")
        self.set_credit_card_info("Mastercard (ending in 8257)")
    ...
    def make_reservation(self, hotel):
        ...
        check_in_date = datetime(2024, 9, 25, 15, 0)
        check_out_date = datetime(2024, 9, 28, 12, 0)
...
room = Room(101, "2 Queen Beds", "No Smoking Desk/Safe Coffee Maker in Room Hair Dryer", False, 1200)
hotel.add_room(room)
...
print("Room Cost: ", room.get_rate_per_night(), "AED per room, per night")
print("Rooms: 1")
print("Nights:", reservation.get_total_nights())
room_subtotal = reservation.calculate_total_cost()
print("Room Subtotal: ", room_subtotal, "AED")
taxes_and_fees = 120
print("Taxes and Fees: ", taxes_and_fees, "AED")
total_charges = room_subtotal + taxes_and_fees
print("Total Charges: ", total_charges, "AED")
